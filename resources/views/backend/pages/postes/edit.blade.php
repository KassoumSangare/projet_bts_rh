    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-lg rounded-4">
                ...
                <div class="card-body">
                    <form class="row g-4 needs-validation" method="POST" action="{{ route('postes.update', $poste->id) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="titre" id="titre" class="form-control"
                                value="{{ old('titre', $poste->titre) }}" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="salaire_base" id="salaire_base" class="form-control"
                                value="{{ old('salaire_base', $poste->salaire_base) }}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="statut" id="statut" class="form-select" required>
                                <option value="" disabled
                                    {{ old('statut', $poste->statut) === null ? 'selected' : '' }}>-- Sélectionnez un statut
                                    --</option>
                                <option value="actif" {{ old('statut', $poste->statut) === 'actif' ? 'selected' : '' }}>
                                    Actif</option>
                                <option value="inactif" {{ old('statut', $poste->statut) === 'inactif' ? 'selected' : '' }}>
                                    Inactif</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="4" required>{{ old('description', $poste->description) }}</textarea>
                            <div class="invalid-feedback">
