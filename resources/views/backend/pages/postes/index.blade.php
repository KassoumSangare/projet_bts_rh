        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('postes.create') }}" type="button" class="btn btn-primary ">
                        Créer</a>
                </div>
                <div class="card-body">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($postes as $key => $poste)
                                        <tr id="row_{{ $poste['id'] }}">
                                            <td> {{ ++$key }} </td>
                                            <td>{{ $poste['titre'] }}</td>
                                            <td>{{ $poste->description ?? 'Nom défini' }}</td>
                                            <td> {{ $poste['salaire_base'] }} </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td class="text-center fw-bold text-danger" colspan="100%">Aucun postes
                                                enregistré</td>
                                        </tr>
                                    @endforelse
                            </table>
