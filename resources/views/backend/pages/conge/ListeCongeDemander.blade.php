        ...
        <div class="col-lg-12">
            <div class="card shadow-sm rounded-4 border-0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="mb-0">Demandes de congés reçues</h3>
                            ...
                            <tbody>
                                @forelse ($demandes as $key => $demande)
                                    <tr id="row_{{ $demande->id }}">
                                        <td>{{ $key + 1 }}</td>
                                        <td class="text-capitalize">{{ $demande->user->username }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('conge.accepteStatut', $demande->id) }}"
                                                class="btn btn-sm btn-outline-success me-1" title="Approuver">
